...
/* bitmasks to isolate parts of instruction */
#define ALUOP_MASK 0x0f
#define IS_REG_MASK 0x1
#define REG_MASK 0x7
#define DEST_ADDR_MASK 0x0f
#define CONST_MASK 0xff

// Branch ops
#define DEST_ADDR_POS 0

#define ALUOP_POS 4
#define TWO_REG_IS_REG_POS 3
#define REG_B_POS 0
#define TWO_REG_REG_A_POS 0

#define CONST_POS 0

/* range of non- 1 byte instructions */
#define LOW_BOUND_TWO OP_MOV
#define UP_BOUND_TWO  OP_BNZ
